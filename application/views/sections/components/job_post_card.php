...
<div class="bg-white p-3 border d-flex flex-column h-100 justify-content-between">
    ...
    <div class="d-flex mb-3 mr-1">
        ...
        <div class="company-logo mr-3 d-none d-sm-block">
            <a href="<?php echo base_url() ?>companies/details/<?php $employerID ?>">
    ...
    <div class="text-right">
        <?php
            if ($this->session->userType == 'Job Seeker') {
                ...
                echo '
                    <a href="' . base_url() . 'auth/edit_post/' . $jobPostID . '" class="btn btn-outline-primary"  data-toggle="tooltip" data-placement="top" title="Edit Post">
                        <i class="fas fa-pen"></i>
                    </a>
                ';
            }
        ?>
        <a href="<?php base_url() ?>jobs/details/<?php echo $jobPostID ?>" class="btn btn-outline-secondary">View More</a>
    </div>
